...
sketch_variable = quick_draw_data_set[random_no];  
console.log(sketch_variable);
document.getElementById("Sketch_name").innerHTML = sketch_variable;
...
function draw(){
    ...
    if(drawn_sketch == sketch_variable){
        answer_holder = "set"; // this means it is equal
        score++;
